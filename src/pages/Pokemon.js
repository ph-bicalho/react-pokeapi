...
const Pokemon = (props) => {
  ...
  return (
    <>
      ...
      <Link to="/" className="retornar">Retonar á Pokedex</Link>
        ...
        {pokemon ? (
          <div className="pokemon-card">
            ...
            <div className="more-info">
                  <h3>Habilidades</h3>
                  <span className={pokemon.types[0].type.name}>{pokemon.abilities[0].ability.name}</span>
                  <span className={pokemon.types[0].type.name}>{pokemon.abilities[1].ability.name}</span>
            </div> 
            </div>      
